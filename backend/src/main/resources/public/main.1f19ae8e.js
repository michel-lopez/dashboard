...
var _default = {
  ...
  methods: {
    loadDashboards: function loadDashboards() {
      ...
      _axios.default.get("/api/dashboards").then(function (_ref) {
        var data = _ref.data;
        _this.dashboards = data._embedded.dashboards;
        console.log(_toConsumableArray(data._embedded.dashboards)[0]._links.self.href);
      }).catch(function (e) {});
    },
    edit: function edit(dashboard) {
      this.active = dashboard;
    },
    remove: function remove(dashboard) {
      _axios.default.delete(dashboard._links.self.href).then(function (response) {}).catch(function (e) {
        console.log(e);
      });
    },
    updateActive: function updateActive() {
      ...
      var dashboard = this.active;

      if (dashboard._links) {
        _axios.default.put(dashboard._links.self.href, dashboard).then(function (response) {
          _this2.active = undefined;

          _this2.dashboards.splice(_this2.dashboard.indexOf(dashboard), 1);
        }).catch(function (e) {});
      } else {
        _axios.default.post("/api/dashboards", dashboard).then(function (response) {
          _this2.active = undefined;

          _this2.dashboards.push(dashboard);
        }).catch(function (e) {});
      }
    },
...
exports.default = _default;
        var $2b1be1 = exports.default || module.exports;
      
      if (typeof $2b1be1 === 'function') {
        $2b1be1 = $2b1be1.options;
      }
    
        /* template */
        Object.assign($2b1be1, (function () {
          var render = function() {
  var _vm = this
      ...
      ? _c(
          ...
          [
            ...
            _c("input", {
              ...
              domProps: { value: _vm.active.name },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.active, "name", $event.target.value)
                }
              }
            }),
            _vm._v(" "),
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("tr", [_c("th"), _vm._v(" "), _c("th", [_vm._v("Name")])])
  }
]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$2b1be1', $2b1be1);
          } else {
            api.reload('$2b1be1', $2b1be1);
          }
        }
...
},{"axios":"../../../node_modules/axios/index.js","vue-hot-reload-api":"../../../node_modules/vue-hot-reload-api/dist/index.js","vue":"../../../node_modules/vue/dist/vue.runtime.esm.js"}],"main.js":[function(require,module,exports) {
"use strict";
